...
<div class="ui container">
    <div class="ui segment" v-bind:class="{ inverted: dark  }">
        ...
        <p>We try to make Akmey accessible everywhere, so we have a npm cli package and a Go client (alpha) released for every platform, everything is under open-source license.</p>
        <div class="ui relaxed divided list">
            <div class="item">
                <i class="large github middle aligned icon"></i>
                <div class="content">
                    <a class="header" href="https://github.com/akmey/akmey-nodejs">akmey/akmey-nodejs</a>
                    <div class="description">Official Akmey client, NodeJS version</div>
                </div>
            </div>
            <div class="item">
                <i class="large github middle aligned icon"></i>
            ...
            <div class="item">
                ...
                <div class="content">
                    ...
                    <div class="description">Akmey client in Go</div>
                </div>
            </div>
            <div class="item">
                <i class="large github middle aligned icon"></i>
                <div class="content">
                    ...
                    <div class="description">Akmey server</div>
                </div>
            </div>
        </div>
    </div>
